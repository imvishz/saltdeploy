...
export class UserProfileComponent implements OnInit {
    ...
    ngOnInit() {
      // this.userId = this.route.snapshot.paramMap.get('id'); // need to get it from url or cookies
      this.userId = "5d4cfd57c2333a24e0c2818e";

      this.dataService.get('/api/user-profile/getprofile/'+this.userId).subscribe((userDetailRes): any => {
        console.log("res",userDetailRes)
        if(userDetailRes){
